...
class MainApp(App):
    ...
    def build(self):
        ...
        for text in result:
            ...
            #img1= Image.fromarray(croppeed, 'RGB')
            ...
            for text1 in result1:
                ...
                xx2 = px2[0]
                # cpx = text[0][2]
                detectedText1 = text1[1]
                croppeed1 = croppeed[yx1:yx2, xx1:xx2]
                #img1= Image.fromarray(croppeed1, 'RGB')

                #cv2.imwrite("IMG_{}.png".format(i), croppeed1)

                btn = Image(croppeed1, size_hint_y= 0.05, size_hint_x=None)
                root.add_widget(btn)
